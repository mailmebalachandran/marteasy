...
import DrawerProduct from '../../components/Products/DrawerProduct';

class DrawerProductScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
        ...
        {!this.state.IsInternetConnected ? (
          ...
          <>
            <View style={{flex: 1}}>
              ...
              <Header
                navigationScreenValue={this.props.route.params.subName}
              ...
              <View
                ...
                {/* <View style={{height: "5%"}}>
                  <View style={{flex: 1, flexDirection: 'row'}}> */}
                    ...
                    {/* <View style={{flex: 0.8, marginLeft: 20, justifyContent: "center", alignItems: "center"}}>
                      <Text
                        style={{
                          fontSize: 20,
                          fontWeight: 'normal',
                        ...
                        {unescape(this.props.route.params.subName) }
                      </Text> */}
                      {/* {this.onAddressDetailsBind()} */}
                ...
                {/* <View style={{height: 35,borderColor: "#4a4a4a",borderRadius:50,backgroundColor: "white",marginTop: "4%", marginBottom: "2%" }}> */}
                  {/* <Line /> */}
                  {/* <Text style={{marginLeft: "5%", marginTop: "1%",color: "#4a4a4a",fontSize: 14}}>{this.state.productList.length} Items</Text> */}
                {/* </View> */}
...
export default DrawerProductScreen;
